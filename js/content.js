...
function regenerateCanva(data) {
    console.log("regenerateCanva");
    chrome.runtime.sendMessage({action: "regenerate-canva", cparams:[], cobject:{}, data: data.detail});
}

document.addEventListener("ccanva", regenerateCanva);
